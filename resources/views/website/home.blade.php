    ...
    <div class="featured-cards-div mt-4">
        ...
        <div class="swiper mySwiper3">
            <div class="swiper-wrapper">
                ...
                <div class="no-featured-products text-center my-5">
                    <h4 class="text-muted">We’re gathering amazing products just for you. ✨</h4>
                    <p class="text-muted">Check back soon to explore our featured items! 🌟</p>
