...
<div>
    <div>
        <div class="p-md-4 p-3">
            <form id="add_edit_testimonial_form">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Testimonial</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Testimonial Listing</li>
                    </ol>
                </nav>
                <div class="row justify-content-center gx-0 gy-2 gap-4 mb-4">
                    <div class="col d-flex justify-content-center gap-2 align-items-center d-card py-3 px-3">
                        ...
                        <div class="ms-3">
                            <h3 class="mb-0 text-center">
                                <span class="fw-bold fs-2" id="state_active"></span>
                            </h3>
                            <small>Active</small>
                        </div>
                    </div>
                    <div class="col d-flex justify-content-center gap-2 align-items-center d-card py-3 px-3">
                        ...
                        <div class="ms-3">
                            <h3 class="mb-0 text-center">
                                <span class="fw-bold fs-2" id="state_inactive"></span>
                            </h3>
                    ...
                    <div class="col d-flex justify-content-center gap-2 align-items-center d-card py-3 px-3">
                        ...
                        <div class="ms-3">
                            <h3 class="mb-0 text-center">
                                <span class="fw-bold fs-2" id="state_total"></span>
                            </h3>
                            <small>Total</small>
                        </div>
                    </div>
                    <div class="col d-flex justify-content-center align-items-center d-card py-md-4 py-3 px-3 modal-add-btn"
                        data-bs-toggle="modal" data-bs-target="#filterModal" data-modal-type="add" id="addBtn">
                ...
                <div id="products">
                    <div class="px-4 py-4 bg-white shadow table-container table-container">
                        <table id="testimonials-listing" class="table table-responsive">
                            <div class="top text-end">
                                <div><label for="dt-search-0">Search:</label><input id="testimonial-search-input" type="search"
                                        class="rounded-5 py-1 px-2" aria-controls="testimonials-listing"></div>
                            <thead>
                                <tr>
                                    <th scope="col">ID</th>
                                    <th class="text-nowrap" scope="col">NAME</th>
                                    <th scope="col" data-sort="category">DESIGNATION</th>
                                    <th scope="col" data-sort="category">DESCRIPTION</th>
                                    <th class="text-center" scope="col">STATUS</th>
                                    <th scope="col">CREATED AT</th>
                                    <th class="text-end" scope="col">ACTIONS</th>
                                </tr>
                            </thead>
                            <tbody id="testimonials_listing_table_body">
    ...
    <div class="modal fade addUpdateModal" id="filterModal" tabindex="-1" aria-hidden="true">
                ...
                <form id="addEventForm" autocomplete="off">
                    ...
                    <div class="modal-body pt-4 pb-2 px-4">
                        <div class="row">
                            ...
                            <div class="col-3 mb-3">
                                ...
                                <div class="input-group position-relative border border-primary rounded shadow-sm overflow-hidden d-flex align-items-center justify-content-center p-1"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                                        class="bi bi-upload text-primary cursor-pointer mb-2" viewBox="0 0 16 16">
                                        <path
                            ...
                            <div class="col-md-12 mb-3 " id="previewSectionMain" style="display: none">
                                <div class="d-flex justify-content-center align-items-center p-2"
                                    id="previewContainer"
                                    style="height: 100px;">
                                    <img id="filePreview" src="" alt="Image Preview" class="img-fluid rounded"
                                        style="display: none; max-height: 100%; object-fit: contain;" />
                                </div>
                            </div>
                    ...
                    <div class="modal-footer d-flex justify-content-center align-items-center px-4 pb-4 pt-3">
                        ...
                        <button class="btn btn-done px-4" type="button" id="editNowBtn">Done</button>
                    </div>
                </form>
            ...
            <div class="modal-content text-center">
                ...
                <div class="modal-body">
                    <div class="d-flex align-items-center justify-content-center my-4">
                        ...
                        <input type="hidden" name="delete-id" id="delete-testimonial-id">
...
@endsection
@push('scripts')
<script src="{{ asset('assets_admin/customjs/testimonials.js') }}"></script>
@endpush
