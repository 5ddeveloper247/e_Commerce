                    ...
                    <div class="row">
                        ...
                        <div class="form-floating col-md-12 mb-3">
                            <input type="text" class="form-control" id="category_name" name="category_name"
                                placeholder="name">
                            <label class="mx-2" for="category_name">categoryname</label>
                        </div>
                        <div class="form-floating col-md-12 mb-3">
                            <textarea type="text" class="form-control" id="category_description"
                                name="category_description" placeholder="description">
                            <label class="mx-2" for="category_name">categorydescription</label>
                        </div>
