                ...
                <div class="btn-group position-static" role="group">
                    <div class="btn-group position-static text-nowrap">
                        <button class="btn btn-outline-secondary px-md-5 px-2 py-2 flex-shrink-0" type="button"
                            ...
                            data-bs-reference="parent"> Category<svg height="1.4em" width="1.4em"
                    ...
                    <div class="btn-group position-static text-nowrap">
                        <button class="btn btn-sm btn-outline-secondary px-md-5 px-2 py-2 flex-shrink-0" type="button"
                            data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"
                            data-bs-reference="parent"> Vendor<svg class="svg-inline--fa fa-angle-down ms-2"
                                width="1.4em" height="1.4em" aria-hidden="true" focusable="false" data-prefix="fas"
                    ...
                    <table class="table fs-9 mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="sort align-middle text-end ps-4 text-nowrap" scope="col" data-sort="price"
                        ...
                        <tbody class="list" id="products-table-body">
                            ...
                            <tr class="position-static">
                                ...
                                <td class="align-middle review fs-8 text-center ps-4"><svg
                                        class="svg-inline--fa fa-star text-warning" aria-hidden="true" focusable="false"
                            ...
                            <tr class="position-static">
                                ...
                                <td class="vendor align-middle text-start fw-semibold ps-4"><a href="#!">Kizzstore</a>
                                </td>
                                <td
                                    class="time align-middle white-space-nowrap text-body-tertiary text-opacity-85 ps-4">
                                    Nov 8, 6:39 PM</td>
