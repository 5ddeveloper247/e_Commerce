        ...
        <div class="row justify-content-center gx-0 gy-4 gap-4">
            ...
            <div class="row justify-content-center gx-0 gy-4 gap-4">
                ...
                <div class="col d-flex justify-content-center gap-2 align-items-center d-card py-3 px-3">
                    ...
                    <div>
                        <h3 class="mb-0">
                            <span class="fw-bold fs-2" id="totalAdmins"></span><small class="fw-normal">Admin</small>
                        </h3>
                ...
                <div class="col d-flex justify-content-center gap-2 align-items-center d-card py-3 px-3">
                    ...
                    <div>
                        <h3 class="mb-0">
                            <span class="fw-bold fs-2" id="totalProducts"></span><small
                                class="fw-normal">Products</small>
                        </h3>
                ...
                <div class="col d-flex justify-content-center gap-2 align-items-center d-card py-3 px-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="2.5em" height="2.5em" viewBox="0 0 24 24">
                        ...
                        <path fill="#004DFF" fill-rule="evenodd"
            ...
            {{-- ____________row 2___________ --}}

            <div class=" mt-2 row justify-content-center gx-0 gy-4 gap-4">
                <div class="col d-flex justify-content-center gap-2 align-items-center d-card py-3 px-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="2.5em" height="2.5em" viewBox="0 0 24 24">
                        <path fill="#004DFF"
                    ...
                    <div>
                        <h3 class="mb-0">
                            <span class="fw-bold fs-2" id="totalCategories"></span><small
                                class="fw-normal">Categories</small>
                        </h3>
                ...
                <div class="col d-flex justify-content-center gap-2 align-items-center d-card py-3 px-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="2.5em" height="2.5em" viewBox="0 0 48 48">
                        <path fill="#004DFF" stroke="#004DFF" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <path fill="#23890B" stroke="#004DFF" stroke-linecap="round" stroke-linejoin="round"
                            d="m19.87 8.465l1.351 13.428L43.5 23.755" />
                    </svg>
                    <div>
                        <h3 class="mb-0">
                            <span class="fw-bold fs-2" id="totalNewsletter"></span><small class="fw-normal">News
                                Letters</small>
                        </h3>
                        <small>All News Letters</small>
                    </div>
                </div>
                ...
                <div class="col d-flex justify-content-center gap-2 align-items-center d-card py-3 px-3">
                    ...
                    <div>
                        <h3 class="mb-0">
                            <span class="fw-bold fs-2" id="totalReviews"></span><small class="fw-normal">Reviews</small>
                        </h3>
            ...
            {{-- <div class="d-flex flex-wrap justify-content-md-between justify-content-center gap-3 my-4">
                <div class="search-box">
                    <form class="position-relative"><input class="form-control search-input search" type="search"
                        ...
                        <svg width="1.4em" height="1.4em" class="svg-inline--fa fa-magnifying-glass search-box-icon"
                    ...
                    <div class="btn-group position-static" role="group">
                        <div class="btn-group position-static text-nowrap">
                            <button class="btn btn-outline-secondary px-md-5 px-2 py-2 flex-shrink-0" type="button"
                                ...
                                aria-expanded="false" data-bs-reference="parent"> Category<svg height="1.4em"
                                    width="1.4em" class="svg-inline--fa fa-angle-down ms-2" aria-hidden="true"
                        ...
                        <div class="btn-group position-static text-nowrap">
                            <button class="btn btn-sm btn-outline-secondary px-md-5 px-2 py-2 flex-shrink-0"
                                type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true"
                                aria-expanded="false" data-bs-reference="parent"> Vendor<svg
                                    class="svg-inline--fa fa-angle-down ms-2" width="1.4em" height="1.4em"
                    ...
                    <div class="row align-items-center justify-content-between py-2 pe-0 fs-9">
                        <div class="col-auto d-flex">
                            <p class="mb-0 d-none d-sm-block me-3 fw-semibold text-body"
                                ...
                                to 10 <span class="text-body-tertiary"> Items of
                                </span>16</p>
