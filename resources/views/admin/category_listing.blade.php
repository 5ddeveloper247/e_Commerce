...
<div>
    ...
    <div class="modal fade filterModal" id="filterModal" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="modal-body pt-4 pb-2 px-4">
                        <div class="row">
                            ...
                            <div class="form-floating col-md-12 mb-3">
                                <input type="text" fieldType="alphabet" maxlength="100" class="form-control"
                                    id="category_name" name="category_name" placeholder="name">
                                <label class="mx-2 required-asterisk" for="generalInfo">category name</label>
                            </div>
                            <div class="form-floating col-md-12 mb-3">
                                <input type="text" fieldType="alphanumeric" maxlength="255" class="form-control"
                                    id="category_description" name="category_description" placeholder="name">
