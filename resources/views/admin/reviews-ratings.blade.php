                        ...
                        <table id="contact-listing" class="table table-responsive">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-nowrap" scope="col">RATING</th>
                                    <th scope="col" data-sort="category">REVIEW</th>
                                    <th class="text-center" scope="col">APPROVE</th>
                                    <th scope="col">CREATED AT</th>

                                </tr>
                            </thead>
                            <tbody id="reviews_listing_table_body">
...
@endsection
@push('scripts')
<script src="{{ asset('assets_admin/customjs/reviews_ratings.js') }}"></script>
@endpush
