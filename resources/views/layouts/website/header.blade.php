    ...
    <nav class="navbar navbar-expand-lg header-bottom pt-0">
        <div class="container">
            <div class="dropdown categories-dropdown">
                <div class="btn d-flex align-items-center shopbycategories rounded-pill dropdown-toggle py-1"
    ...
    <nav class="navbar navbar-expand-lg small-nav">
        <div class="container">
            ...
            <a class="navbar-brand mx-auto" href="#">
                <img class="img-fluid rounded-4" src="{{ url('/').'/'.$siteLogo }}" alt="">
            </a>
    ...
    <nav class="navbar navbar-expand-lg header-top bg-dark py-1">
        <div class="container">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p class="text-start mb-2">Delivery options and delivery speeds may vary for different
                                locations.</p>
                            <div class="d-flex justify-content-center mb-2">
                                <button class="btn btn-warning px-md-5 rounded-pill">Sign in to see your
                                    addresses</button>
                            </div>
                            <div class="mb-2">
            ...
            <div class="d-flex align-items-center" role="search">
                ...
                <div class="dropdown-center">
                    <a class="px-2 text-decoration-none d-flex align-items-end" type="button" data-bs-toggle="dropdown"
                        ...
                        <p class="mb-0 text-white lh-1 text-nowrap">
                            <small>
                                Hello, {{Auth::user() ? Auth::user()->first_name : 'sign in'}}
                            </small>
                            <br>
                            Account & Lists
                        </p>
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="{{url('register')}}">
                                <svg class="me-1" xmlns="http://www.w3.org/2000/svg" width="1.3em" height="1.3em"
                                    viewBox="0 0 32 32">
                                    <path fill="#000"
                                        d="M20.77 12.364s.85-3.51 0-4.7c-.85-1.188-1.188-1.98-3.057-2.547s-1.188-.454-2.547-.396s-2.492.793-2.492 1.19c0 0-.85.056-1.188.396c-.34.34-.906 1.924-.906 2.32s.283 3.06.566 3.625l-.337.114c-.284 3.283 1.13 3.68 1.13 3.68c.51 3.058 1.02 1.756 1.02 2.548s-.51.51-.51.51s-.452 1.245-1.584 1.698s-7.416 2.886-7.927 3.396c-.512.51-.454 2.888-.454 2.888h26.947s.06-2.377-.452-2.888c-.51-.51-6.795-2.944-7.927-3.396c-1.132-.453-1.584-1.698-1.584-1.698s-.51.282-.51-.51s.51.51 1.02-2.548c0 0 1.413-.397 1.13-3.68h-.34z" />
                                </svg>
                ...
                <a class="px-2" href="{{ route('user.dashboard') }}">
                    ...
                    <span class="position-absolute top-5 start-500 translate-middle  rounded-pill"
                        id="wishListHeader">0</span> </a>
...
<div class="d-lg-none d-block">
    <nav class="navbar navbar-expand-lg small-nav">
        <div class="container">
            <!-- Offcanvas Toggle Button -->
            <button class="btn me-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasMenuu"
                aria-controls="offcanvasMenuu">
                <svg xmlns="http://www.w3.org/2000/svg" width="1.7em" height="1.7em" viewBox="0 0 24 24">
                    <path fill="currentColor" d="M3 18v-2h18v2zm0-5v-2h18v2zm0-5V6h18v2z"></path>
                </svg>
            </button>
            ...
            <a class="navbar-brand mx-auto" href="{{url('/')}}">
                <img class="img-fluid" src="{{ asset('/common/logo4.png') }}" alt="">
            </a>
                    ...
                    <div class="dropdown-center">
                        <div class="px-2 cart-with-count">
                            ...
                            <div class="dropdown-menu" style="margin-left:-15rem; width:18rem">
                                ...
                                <div class="d-flex justify-content-center px-3 pb-2">
                                    <a type="button" href="{{'cart'}}" class="btn btn-dark me-2 rounded-pill">View
                                        Cart</a>
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasMenuu" aria-labelledby="offcanvasMenuuLabel"
    ...
    <div class="offcanvas-header bg-dark text-white mb-2">
        ...
        <button type="button" class="btn-close btn-close-white mt-0" data-bs-dismiss="offcanvas"
            ...
            <li class="px-md-3 px-2 py-1">
                <a class="dropdown-item d-flex align-items-center justify-content-between py-2 border-bottom"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 512 512">
                        <path fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="48"
