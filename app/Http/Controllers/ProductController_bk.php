...
class ProductController extends Controller
{
    ...
    public function storeProductModel(Request $request){
        ...
        return response()->json(['success' => true, 'message' => 'Product model name added successfully', 'status' => 200]);
    }
...
// Route::post('/product/store/model', [ProductController::class, 'storeProductModel'])->name('admin.product.store.model');
// Route::post('/product/get/specifications', [ProductController::class, 'getProductSpecifications'])->name('admin.product.get.specifications');
// Route::post('/product/store/specifications', [ProductController::class, 'storeProductSpecifications'])->name('admin.product.store.specifications');
